# ================================================
#   GuiSS Tools Launcher - Vorige Versie (mooie layout)
# ================================================
    ...
    <Border Background="#0F1A14" CornerRadius="12" BorderBrush="#1E8C4A" BorderThickness="2">
        <Grid>
            ...
            <Border Grid.Row="0" Background="#1A2A22" CornerRadius="12,12,0,0">
                <Grid>
                    <TextBlock Text="GuiSS Tools Launcher" Margin="25,0,0,0" VerticalAlignment="Center" FontSize="16" FontWeight="SemiBold" Foreground="#A8FFCC"/>
            ...
            <Grid Grid.Row="1" Margin="20">
                ...
                <Border Grid.Column="0" Background="#1A2A22" CornerRadius="8" Padding="15" Margin="0,0,10,0">
                    <StackPanel>
                        ...
                        <TextBlock Text="Launch your tools easily." FontSize="12" Foreground="#8CFFBB" Margin="0,0,0,20"/>
                ...
                <StackPanel Grid.Column="1" Margin="10,0,0,0">
                    ...
                    <Border Background="#1A2A22" CornerRadius="8" Padding="20" Margin="0,0,0,15">
                        <StackPanel>
                            ...
                            <TextBlock Text="The toolkit is ready on this system." FontSize="12" Foreground="#8CFFBB" Margin="0,8,0,15"/>
                    ...
                    <Grid>
                        ...
                        <Border Grid.Column="2" Background="#1A2A22" CornerRadius="8" Padding="15">
                            <StackPanel>
                                <TextBlock Text="6" FontSize="18" FontWeight="Bold" Foreground="#A8FFCC"/>
